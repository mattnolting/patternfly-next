...
| `.pf-m-selected` | `.pf-c-page__header-tools .pf-c-button`, `.pf-c-page__header-tools .pf-c-dropdown__toggle`, `.pf-c-page__header-tools pf-c-options-menu__toggle`, `.pf-c-page__header-tools .pf-c-app-launcher__toggle` | Modifies the button in the masthead for the selected state. |
